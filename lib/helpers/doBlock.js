...
let getResponseFunction = require('./getResponseFunction');

let models = require('../../models');

module.exports = function doBlock(rtmBot, bot, message, content, blockChannel, channelMention) {
	log.verbose('Got user standup info:\n' + content);

	let responseFn = getResponseFunction(rtmBot, bot, message, false, true);
